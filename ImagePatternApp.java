...
public class ImagePatternApp extends Application
{
	...
	public void init()
	{
		...
		String IMAGE_PATTERN = "D://Photos/Saddam.jpg";
		URL url = this.getClass().getClassLoader().getResource("Saddam.jpg");
		if(url==null)
		{
		...
		img = new Image("Saddam.jpg");
	}
	
	@Override
	public void start(Stage stage)
	{
		//An anchor rectange at (0,0) that is 25% wide and 25% tall
