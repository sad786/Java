...
public class JSHandlers 
{
	...
	//Returns a Callback to handle window.open() call by dislaying the popup
	...
	//Returns a Callback to handle window.confirm() call by displaying a message4
	public static Callback<String,Boolean> getConfirmHandler()
	{
		Callback<String,Boolean> handler = msg ->
		{
			...
			VBox root = new VBox(20,msgLbl,cancelBtn);
			Scene scene = new Scene(root);
			stage.setScene(scene);
			stage.showAndWait();
