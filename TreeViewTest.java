...
public class TreeViewTest extends Application
{
	...
	public void start(Stage stage)
	{
		...
		//Create the rood nod eand adds event handle ot it
	...
	public VBox getRightPane()
	{
		...
		addItemBtn.setDefaultButton(true);
		Button removeItemBtn = new Button("Remove Selcted Item");
	...
	public void addItem(String value)
	{
		...
		if(parent==null)
		{
			this.logMsg(value+" alreaddy exists under "+parent.getValue());
			return;
		}
	...
	public void removeItem()
	{
		...
		if(item==null)
		{
			this.logMsg("Select a node ot remove.");
			return;
		}
