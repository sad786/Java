...
public class MicroHelp extends Application
{
	...
	public void start(Stage stage)
	{
		...
		salary.getProperties().put("microsHelpText","Enter a salary greater than $2000.00");
	...
	public void focusChanged(ObservableValue<? extends Node> value,Node oldValue, Node newNode)
	{
